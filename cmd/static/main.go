...
func main() {
	td := createData()
	t, err := template.ParseFiles("template/default.gohtml", "template/footer.gohtml", "template/header.gohtml", "template/headline.gohtml", "template/meta.gohtml", "template/style.gohtml")
	if err != nil {
		panic(err)
	}
